...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "Длина деполяризации, мкм"))
        self.beat_length.setText(_translate("MainWindow", "0"))
        self.depolarization_length.setText(_translate("MainWindow", "0"))
        ...
        self.graphType.setItemText(1, _translate("MainWindow", "PER"))
        self.graphType.setItemText(2, _translate("MainWindow", "Видность"))
        self.graphType.setItemText(3, _translate("MainWindow", "Фильтрованная видность"))
        self.graphType.setItemText(4, _translate("MainWindow", "Интерференция"))
        self.graphType.setItemText(5, _translate("MainWindow", "Фильтрованная интерференция"))
        self.graphType.setItemText(6, _translate("MainWindow", "Фильтр интерференции"))
        self.graphType.setItemText(7, _translate("MainWindow", "Фильтр видности"))
